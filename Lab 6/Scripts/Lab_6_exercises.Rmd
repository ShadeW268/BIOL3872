...
#creating extra columns by extracting info from Date column
Bedford_ts$Year <- year(Bedford_ts$Date)
Bedford_ts$Month <- month(Bedford_ts$Date)
Bedford_ts$Day <- day(Bedford_ts$Date)

#converting month numbers to names in a new column
Bedford_ts$Month_name <- month.abb[Bedford_ts$Month]

#combiningyear, month, and day columns into a new date object
Bedford_ts %>%
  Bedford_Date
